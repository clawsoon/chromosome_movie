...
data = working/'data'
images = working/f'{width}x{height}'/'layers'
audio = working/'audio'
movie = working/f'{width}x{height}'/'movie'
...
# I've been using G.Projector, Inkscape, and GIMP.
default_world_map = code/'maps'/f'{map_image}_{map_projection}_{map_rotation[0]}_{map_rotation[1]}_{map_width}x{map_height}.png'
...
layers.chromosome_map.sections = [
    {'axis': 'width', 'start': (928, 1280), 'end': (800, 1320)},
    {'axis': 'width', 'start': (800, 1280), 'end': (0, 1440)},
    {'axis': 'height', 'start': (0, 1280), 'end': (160, 160)},
    {'axis': 'width', 'start': (0, 160), 'end': (1920, 0)},
    {'axis': 'height', 'start': (1920, 160), 'end': (1760, 1280)},
    {'axis': 'width', 'start': (1920, 1280), 'end': (1120, 1440)},
    {'axis': 'width', 'start': (1120, 1280), 'end': (992, 1320)},
]
...
layers.worldwide_frequency.center = (int(220/1920*width), int(220/1440*height))
...
layers.clef.center = (2264/1920*width, 296/1440*height)
layers.clef.width = 280/1440*height
layers.clef.height = 280/1440*height

layers.variant.center = (2100/1920*width, 1132/1440*height)
...
layers.legend_frequency.center = (600/1920*width, 296/1440*height)
...
layers.legend_position.center = (585/1920*width, 1132/1440*height)
